...
**Cap:** a tenth of your boot payload budget across all pending promises, floored at 2,048 bytes and capped at 10,240. Call `revell_payload_list` for your exact number. Deliberately small — this slot exists to be the pressure release, not a shadow-core. Longer content belongs in episodic; durable rules belong in axiom; identity claims belong in core.
